...
public class PrivilegedInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		Member member = (Member) request.getSession().getAttribute("loggedinUserInfo");
		if (member.getRole() != Role.Admin) {
			logger.warn("User [{}] does not have privilege to access this page, but trying.", member);
			String url = request.getContextPath() + "/timedout";
			response.sendRedirect(url);
			return false;
		}
